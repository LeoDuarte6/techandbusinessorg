...
import {
  ...
  usePortal,
  useToast
} from "./chunk-HC3I34DW.js";
import {
  require_dist
} from "./chunk-FTCZ2CEJ.js";
import {
  require_jsx_runtime
} from "./chunk-EU35GXS4.js";
import {
  require_react
} from "./chunk-FQRNS6GS.js";
import {
  __commonJS,
  __toESM
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources7-PO42ZGNF.js")
});
...
function useCreatePathSyncChannel() {
  const $ = (0, import_react_compiler_runtime2.c)(1);
  let t0;
...
function useDiffViewState(t0) {
  const $ = (0, import_react_compiler_runtime2.c)(22);
  let t1;
...
function useScrollMirror(elements) {
  const $ = (0, import_react_compiler_runtime2.c)(3);
  let t0, t1;
  $[0] !== elements ? (t0 = () => {
...
var VersionModeHeader = (t0) => {
  ...
  let t10;
  $[28] === Symbol.for("react.memo_cache_sentinel") ? (t10 = (0, import_jsx_runtime2.jsx)(Flex, { align: "center", paddingX: 3, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(TransferIcon, {}) }) }), $[28] = t10) : t10 = $[28];
  let t11;
...
var VersionMenu = (t0) => {
  const $ = (0, import_react_compiler_runtime2.c)(41), {
    releases: t1,
    onSelectRelease,
    role,
    documentId,
...
var VersionMenuItem = (t0) => {
  const $ = (0, import_react_compiler_runtime2.c)(51), {
    type,
    release,
    onSelect,
    isSelected,
...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t32 = (t4) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t32) : t32 = $[7], t2 = syncChannel.pipe(distinctUntilChanged(_temp$F), filter(t32), map(_temp2$h)), $[3] = id, $[4] = syncChannel, $[5] = t2;
  } else
    t2 = $[5];
  const path = t2;
  let t3;
...
var DiffViewPane = (0, import_react2.forwardRef)(function(t0, ref) {
  const $ = (0, import_react_compiler_runtime2.c)(36), {
    role,
    documentType,
    documentId,
    scrollElement,
...
var DiffViewDocument = (t0) => {
  const $ = (0, import_react_compiler_runtime2.c)(52), {
    role,
    documentType,
    documentId,
    syncChannel,
...
function useCompareValue(t0) {
  const $ = (0, import_react_compiler_runtime2.c)(4), {
    compareDocument
  } = t0;
  let t1;
...
function PaneDivider(t0) {
  const $ = (0, import_react_compiler_runtime2.c)(7), {
    disabled,
    element
  } = t0, {
    resize
...
var Pane = (0, import_react2.forwardRef)(function(props, forwardedRef) {
  const $ = (0, import_react_compiler_runtime2.c)(86);
...
function PaneMenuButtonItem(props) {
  const $ = (0, import_react_compiler_runtime2.c)(35), {
    disabled,
    isAfterGroup,
    node
...
function PaneContextMenuItemResolver(props) {
  const $ = (0, import_react_compiler_runtime2.c)(5), {
    node
  } = props;
  if (node.intent) {
    let t02;
...
function PaneContextMenuItem(props) {
  const $ = (0, import_react_compiler_runtime2.c)(19), {
    disabled,
    node
  } = props;
  let t0;
...
function PaneContextIntentMenuItem(props) {
  const $ = (0, import_react_compiler_runtime2.c)(23), {
    disabled,
    intent,
    node
  } = props;
...
var PaneHeader$1 = (0, import_react2.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime2.c)(48), {
    actions,
    backButton,
    border,
    contentAfter,
...
function PaneHeaderActionIntentButton(props) {
  const $ = (0, import_react_compiler_runtime2.c)(27), {
    intent,
    node
  } = props;
  let t0;
...
function ErrorPane(props) {
  const $ = (0, import_react_compiler_runtime2.c)(12), {
    children,
    currentMinWidth,
    flex,
    minWidth,
...
function CommentsWrapper(props) {
  const $ = (0, import_react_compiler_runtime2.c)(8), {
    children,
    documentId,
    documentType
  } = props;
...
function CommentsProviderWrapper(props) {
  const $ = (0, import_react_compiler_runtime2.c)(26), {
    children,
    documentId,
    documentType
  } = props, {
...
function DocumentActionsProvider(props) {
  ...
  const t3 = actions || EMPTY_ARRAY$B;
  let t4;
  ...
  let t5;
  return $[10] !== t2 || $[11] !== t3 || $[12] !== t4 ? (t5 = (0, import_jsx_runtime2.jsx)(GetHookCollectionState, { args: t2, hooks: t3, resetRef: onCompleteRef, children: t4 }), $[10] = t2, $[11] = t3, $[12] = t4, $[13] = t5) : t5 = $[13], t5;
}
...
function DocumentInspectorHeader(props) {
  const $ = (0, import_react_compiler_runtime2.c)(25);
...
function useStructureToolSetting(namespace, key, defaultValue) {
  const $ = (0, import_react_compiler_runtime2.c)(16), keyValueStore = useKeyValueStore();
  let t0;
...
function InspectDialog(props) {
  const $ = (0, import_react_compiler_runtime2.c)(49), {
    value
  } = props, {
    onInspectClose,
    paneKey
...
function DeletedDocumentBanner() {
  const $ = (0, import_react_compiler_runtime2.c)(17), {
    documentId,
    documentType
  } = useDocumentPane(), {
    restore
...
function RequestPermissionDialog(t0) {
  const $ = (0, import_react_compiler_runtime2.c)(56), {
    onClose,
    onRequestSubmitted
  } = t0, {
    t: t2
...
function InsufficientPermissionBanner(t0) {
  ...
  const listFormat = useListFormat(t1), {
    t: t2
  } = useTranslation(structureLocaleNamespace), telemetry = useTelemetry(), roleTitles = currentUserRoles.map(_temp$A), roles = listFormat.formatToParts(roleTitles).map(_temp2$e);
  let t22;
  $[1] !== roles ? (t22 = {
...
var ReferenceChangedBanner = (0, import_react2.memo)(() => {
  const $ = (0, import_react_compiler_runtime2.c)(30), documentPreviewStore = useDocumentPreviewStore(), {
    selectedReleaseId
  } = usePerspective(), {
    params,
    groupIndex,
  ...
  bb0: {
    ...
    if ($[3] !== documentPreviewStore || $[4] !== parentId || $[5] !== parentRefPath || $[6] !== parentRefPathSegment || $[7] !== selectedReleaseId) {
      ...
      }).pipe(debounceTime(750), map(t32))), $[3] = documentPreviewStore, $[4] = parentId, $[5] = parentRefPath, $[6] = parentRefPathSegment, $[7] = selectedReleaseId, $[8] = t222;
    } else
      t222 = $[8];
    t1 = t222;
  }
  ...
  let t22;
  $[11] === Symbol.for("react.memo_cache_sentinel") ? (t22 = {
    loading: true
  }, $[11] = t22) : t22 = $[11];
...
var CanvasLinkedBannerContent = (t0) => {
  ...
  let t22;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t22 = () => setOpen(_temp$y), $[6] = t22) : t22 = $[6];
...
function CanvasLinkedBanner() {
  const $ = (0, import_react_compiler_runtime2.c)(10), {
    documentId,
    displayed
  } = useDocumentPane(), {
    t: t2
...
function DocumentNotInReleaseBanner(t0) {
  const $ = (0, import_react_compiler_runtime2.c)(39), {
    documentId,
    currentRelease,
    isScheduledRelease
...
var ObsoleteDraftBanner = (t0) => {
  const $ = (0, import_react_compiler_runtime2.c)(47), {
    displayed,
    documentId,
    schemaType,
    i18nKey,
...
function OpenReleaseToEditBannerInner(t0) {
  ...
  let t8;
  $[26] !== t6 ? (t8 = t6("banners.release.action.open-to-edit"), $[26] = t6, $[27] = t8) : t8 = $[27];
  let t9;
  ...
  let t10;
  return $[32] !== t7 || $[33] !== t9 || $[34] !== tone ? (t10 = (0, import_jsx_runtime2.jsx)(Banner, { tone, "data-testid": "open-release-to-edit-banner", content: t7, action: t9 }), $[32] = t7, $[33] = t9, $[34] = tone, $[35] = t10) : t10 = $[35], t10;
}
...
function UnpublishedDocumentBanner() {
  const $ = (0, import_react_compiler_runtime2.c)(18), {
    value,
    editState
  } = useDocumentPane(), {
    selectedPerspective
...
var FormView = (0, import_react2.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime2.c)(77), {
    hidden,
    margins
  } = props, {
    collapsedFieldSets,
    ...
    title
  } = useDocumentTitle(), [patchChannel] = (0, import_react2.useState)(_temp$x), isLocked = editState?.transactionSyncLock?.enabled, {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t0;
...
function DocumentHeaderTab(props) {
  const $ = (0, import_react_compiler_runtime2.c)(20);
...
function useResolvedPanesList() {
  const $ = (0, import_react_compiler_runtime2.c)(1), context = (0, import_react2.useContext)(ResolvedPanesContext);
  let t0;
...
function DocumentHeaderTitle() {
  ...
  if (connectionState === "connecting" && !subscribed) {
    let t12;
    return $[2] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, {}), $[2] = t12) : t12 = $[2], t12;
  }
  if (title) {
    let t12;
...
var DocumentPanelSubHeader = (0, import_react2.memo)(function() {
  ...
  let t0;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime2.jsx)(DocumentHeaderTitle, {}), $[0] = t0) : t0 = $[0];
  const title = t0;
  let t1;
...
var DocumentPanel = function(props) {
  const $ = (0, import_react_compiler_runtime2.c)(109), {
    footerHeight,
    headerHeight,
    isInspectOpen,
    rootElement,
  ...
  bb1: {
    if (params?.historyVersion) {
      let t133;
      $[38] === Symbol.for("react.memo_cache_sentinel") ? (t133 = (0, import_jsx_runtime2.jsx)(ArchivedReleaseDocumentBanner, {}), $[38] = t133) : t133 = $[38], t12 = t133;
      break bb1;
    }
    let t132;
    ...
    if (selectedPerspective === "drafts" && hasCardinalityOneReleases && displayedIsDraft) {
      let t153;
      $[54] === Symbol.for("react.memo_cache_sentinel") ? (t153 = (0, import_jsx_runtime2.jsx)(ScheduledDraftOverrideBanner, {}), $[54] = t153) : t153 = $[54], t12 = t153;
      break bb1;
    }
    let t152;
    ...
    if (displayed?._id && getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish && isNewDocument(editState) === false && !isCurrentVersionGoingToUnpublish) {
      const t163 = selectedPerspective;
      let t172;
      $[57] !== isScheduledRelease || $[58] !== t163 || $[59] !== value._id ? (t172 = (0, import_jsx_runtime2.jsx)(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: t163, isScheduledRelease }), $[57] = isScheduledRelease, $[58] = t163, $[59] = value._id, $[60] = t172) : t172 = $[60], t12 = t172;
      break bb1;
    }
...
var useHistoryRestoreAction = (t0) => {
  ...
  let t22;
  $[3] === Symbol.for("react.memo_cache_sentinel") ? (t22 = () => {
...
function useChipScrollPosition(containerRef) {
  const $ = (0, import_react_compiler_runtime2.c)(3), [showGradient, setShowGradient] = (0, import_react2.useState)(false);
  let t0, t1;
...
var DocumentPerspectiveList = (0, import_react2.memo)(function() {
  const $ = (0, import_react_compiler_runtime2.c)(97), {
    selectedReleaseId,
    selectedPerspectiveName
  } = usePerspective(), {
    t: t2
  ...
  const onlyHasVersions = useOnlyHasVersions(t22), workspace = useWorkspace(), {
  ...
  if ($[16] !== documentType || $[17] !== schema) {
    ...
    t5 = schemaType ? isLiveEditEnabled(schemaType) : false, $[16] = documentType, $[17] = schema, $[18] = t5;
  } else
    t5 = $[18];
  const isLiveEdit = t5;
  let t6;
  ...
  let t10;
  $[29] !== editState?.draft || $[30] !== isCreatingDocument || $[31] !== isLiveEdit || $[32] !== onlyHasVersions || $[33] !== selectedReleaseId ? (t10 = () => onlyHasVersions || isCreatingDocument && selectedReleaseId ? true : !editState?.draft && !isLiveEdit ? false : !!(isCreatingDocument && selectedReleaseId || isLiveEdit), $[29] = editState?.draft, $[30] = isCreatingDocument, $[31] = isLiveEdit, $[32] = onlyHasVersions, $[33] = selectedReleaseId, $[34] = t10) : t10 = $[34];
  const isDraftDisabled = t10(), isDraftModelEnabled = workspace.document.drafts?.enabled;
  let t11;
  $[35] !== dateTimeFormat || $[36] !== editState?.published || $[37] !== t2 ? (t11 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: editState?.published && editState?.published?._updatedAt ? (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.published-date", values: {
    date: dateTimeFormat.format(new Date(editState?.published._updatedAt))
  } }) : (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t2("release.chip.tooltip.not-published") }) }), $[35] = dateTimeFormat, $[36] = editState?.published, $[37] = t2, $[38] = t11) : t11 = $[38];
  let t12;
  $[39] !== handlePerspectiveChange ? (t12 = handlePerspectiveChange("published"), $[39] = handlePerspectiveChange, $[40] = t12) : t12 = $[40];
  let t13;
  $[41] !== t2 ? (t13 = t2("release.chip.published"), $[41] = t2, $[42] = t13) : t13 = $[42];
  ...
  $[58] !== dateTimeFormat || $[59] !== documentType || $[60] !== editState?.draft || $[61] !== editState?.id || $[62] !== editState?.published?._id || $[63] !== filteredReleases.notCurrentReleases || $[64] !== handleCopyToDraftsNavigate || $[65] !== handlePerspectiveChange || $[66] !== isDraftDisabled || $[67] !== isDraftModelEnabled || $[68] !== isDraftSelected || $[69] !== isLiveEdit || $[70] !== loading || $[71] !== t2 ? (t19 = isDraftModelEnabled && (0, import_jsx_runtime2.jsx)(VersionChip$1, { tooltipContent: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: editState?.draft ? (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: editState?.draft._updatedAt ? (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.edited-date", values: {
    ...
    fromRelease: "draft",
    isVersion: false
  } }), $[58] = dateTimeFormat, $[59] = documentType, $[60] = editState?.draft, $[61] = editState?.id, $[62] = editState?.published?._id, $[63] = filteredReleases.notCurrentReleases, $[64] = handleCopyToDraftsNavigate, $[65] = handlePerspectiveChange, $[66] = isDraftDisabled, $[67] = isDraftModelEnabled, $[68] = isDraftSelected, $[69] = isLiveEdit, $[70] = loading, $[71] = t2, $[72] = t19) : t19 = $[72];
  let t20;
  $[73] !== displayed?._id || $[74] !== documentType || $[75] !== filteredReleases.inCreation || $[76] !== filteredReleases.notCurrentReleases || $[77] !== handleCopyToDraftsNavigate || $[78] !== loading || $[79] !== t2 ? (t20 = filteredReleases.inCreation && (0, import_jsx_runtime2.jsx)(VersionChip$1, { tooltipContent: (0, import_jsx_runtime2.jsx)(TooltipContent$1, { release: filteredReleases.inCreation }), selected: true, onClick: _temp$t, locked: false, tone: getReleaseTone(filteredReleases.inCreation), text: filteredReleases.inCreation.metadata.title || t2("release.placeholder-untitled-release"), onCopyToDraftsNavigate: handleCopyToDraftsNavigate, contextValues: {
    disabled: true,
  ...
  } }), $[73] = displayed?._id, $[74] = documentType, $[75] = filteredReleases.inCreation, $[76] = filteredReleases.notCurrentReleases, $[77] = handleCopyToDraftsNavigate, $[78] = loading, $[79] = t2, $[80] = t20) : t20 = $[80];
  let t21;
  $[81] !== displayed || $[82] !== documentType || $[83] !== editState?.version || $[84] !== filteredReleases.currentReleases || $[85] !== filteredReleases.notCurrentReleases || $[86] !== getReleaseChipState || $[87] !== handleCopyToDraftsNavigate || $[88] !== handlePerspectiveChange || $[89] !== loading || $[90] !== t2 ? (t21 = displayed && filteredReleases.currentReleases?.map((release_0) => (0, import_jsx_runtime2.jsx)(VersionChip$1, { tooltipContent: (0, import_jsx_runtime2.jsx)(TooltipContent$1, { release: release_0 }), ...getReleaseChipState(release_0), onClick: handlePerspectiveChange(release_0), text: release_0.metadata.title || t2("release.placeholder-untitled-release"), tone: getReleaseTone(release_0), locked: isReleaseScheduledOrScheduling(release_0), onCopyToDraftsNavigate: handleCopyToDraftsNavigate, contextValues: {
    documentId: displayed?._id || "",
    ...
    release: release_0
  } }, release_0._id)), $[81] = displayed, $[82] = documentType, $[83] = editState?.version, $[84] = filteredReleases.currentReleases, $[85] = filteredReleases.notCurrentReleases, $[86] = getReleaseChipState, $[87] = handleCopyToDraftsNavigate, $[88] = handlePerspectiveChange, $[89] = loading, $[90] = t2, $[91] = t21) : t21 = $[91];
  let t222;
  return $[92] !== t18 || $[93] !== t19 || $[94] !== t20 || $[95] !== t21 ? (t222 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    t18,
    t19,
    t20,
    t21
  ] }), $[92] = t18, $[93] = t19, $[94] = t20, $[95] = t21, $[96] = t222) : t222 = $[96], t222;
});
function _temp$t() {
}
...
var DocumentPanelHeader = (0, import_react2.memo)((0, import_react2.forwardRef)(function(_props, ref) {
  ...
  return $[18] !== BackLink2 || $[19] !== backButton || $[20] !== collapsed || $[21] !== connectionState || $[22] !== contextMenuNodes || $[23] !== editState || $[24] !== handleFocusPane || $[25] !== isMaximizedPane || $[26] !== menuButtonNodes || $[27] !== onPaneClose || $[28] !== onPaneSplit || $[29] !== onSetMaximizedPane || $[30] !== ref || $[31] !== referenceElement || $[32] !== schemaType || $[33] !== showGradient || $[34] !== showPaneGroupCloseButton || $[35] !== showSplitPaneButton || $[36] !== showSplitPaneCloseButton || $[37] !== t3 || $[38] !== tabIndex || $[39] !== unstable_languageFilter ? (t7 = (0, import_jsx_runtime2.jsx)(TooltipDelayGroupProvider, { children: collapsed ? (0, import_jsx_runtime2.jsx)(PaneHeader$1, { border: true, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabIndex, backButton }) : (0, import_jsx_runtime2.jsx)(Card, { hidden: collapsed, style: {
    ...
    (0, import_jsx_runtime2.jsx)(Box, { flex: "none", paddingRight: 3, children: (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 1, children: [
      ...
      editState && (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { group: "paneActions", children: (t8) => {
        const {
          states: states_0
        } = t8;
        return (0, import_jsx_runtime2.jsx)(DocumentPanelHeaderActionDialogDeferred, { contextMenuNodes, setReferenceElement, referenceElement, states: states_0 });
      } }),
  ...
  ] }) }) }), $[18] = BackLink2, $[19] = backButton, $[20] = collapsed, $[21] = connectionState, $[22] = contextMenuNodes, $[23] = editState, $[24] = handleFocusPane, $[25] = isMaximizedPane, $[26] = menuButtonNodes, $[27] = onPaneClose, $[28] = onPaneSplit, $[29] = onSetMaximizedPane, $[30] = ref, $[31] = referenceElement, $[32] = schemaType, $[33] = showGradient, $[34] = showPaneGroupCloseButton, $[35] = showSplitPaneButton, $[36] = showSplitPaneCloseButton, $[37] = t3, $[38] = tabIndex, $[39] = unstable_languageFilter, $[40] = t7) : t7 = $[40], t7;
}));
...
var DocumentBadgesDeferred = (0, import_react2.memo)(function(props) {
  const $ = (0, import_react_compiler_runtime2.c)(2), states = (0, import_react2.useDeferredValue)(props.states);
  let t0;
...
var useDeleteAction = (t0) => {
  ...
  let t22;
  $[1] !== deleteOp || $[2] !== paneSetIsDeleting ? (t22 = () => {
    setIsDeleting(true), setConfirmDialogOpen(false), paneSetIsDeleting(true), deleteOp.execute(), setIsDeleting(false);
  }, $[1] = deleteOp, $[2] = paneSetIsDeleting, $[3] = t22) : t22 = $[3];
  ...
  bb0: {
    if (!isPermissionsLoading && !permissions?.granted) {
      let t62;
      $[9] !== t2 ? (t62 = t2("action.delete.label"), $[9] = t2, $[10] = t62) : t62 = $[10];
      let t72;
      $[11] !== currentUser ? (t72 = (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessage, { context: "delete-document", currentUser }), $[11] = currentUser, $[12] = t72) : t72 = $[12];
      let t82;
      $[13] !== t62 || $[14] !== t72 ? (t82 = {
        tone: "critical",
        icon: TrashIcon,
    ...
    let t7;
    $[16] !== deleteOp.disabled || $[17] !== t2 ? (t7 = deleteOp.disabled && t2(DISABLED_REASON_TITLE_KEY$1[deleteOp.disabled]) || "", $[16] = deleteOp.disabled, $[17] = t2, $[18] = t7) : t7 = $[18];
    let t8;
    $[19] !== isDeleting || $[20] !== t2 ? (t8 = t2(isDeleting ? "action.delete.running.label" : "action.delete.label"), $[19] = isDeleting, $[20] = t2, $[21] = t8) : t8 = $[21];
    let t9;
...
var useDiscardChangesAction = (t0) => {
  const $ = (0, import_react_compiler_runtime2.c)(26), {
    ...
    discardChanges
  } = useDocumentOperation(id, type, release), [isConfirmDialogOpen, setConfirmDialogOpen] = (0, import_react2.useState)(false);
  let t1;
  ...
  let t22;
  $[4] !== displayed?._id ? (t22 = displayed?._id && isPublishedId(displayed?._id), $[4] = displayed?._id, $[5] = t22) : t22 = $[5];
  const isPublished = t22;
  let t3;
  $[6] !== discardChanges ? (t3 = () => {
  ...
  const handle = t5;
  let t6;
  $[10] !== handleConfirm || $[11] !== isConfirmDialogOpen || $[12] !== t2 ? (t6 = isConfirmDialogOpen && {
    type: "confirm",
    tone: "critical",
    onCancel: handleCancel,
    onConfirm: handleConfirm,
    message: t2("action.discard-changes.confirm-dialog.confirm-discard-changes")
  }, $[10] = handleConfirm, $[11] = isConfirmDialogOpen, $[12] = t2, $[13] = t6) : t6 = $[13];
  const dialog = t6;
  let t7;
  $[14] !== currentUser || $[15] !== dialog || $[16] !== discardChanges.disabled || $[17] !== isPermissionsLoading || $[18] !== isPublished || $[19] !== liveEdit || $[20] !== permissions?.granted || $[21] !== published || $[22] !== t2 ? (t7 = () => !published || liveEdit || isPublished ? null : !isPermissionsLoading && !permissions?.granted ? {
    tone: "critical",
    icon: ResetIcon,
    disabled: true,
    ...
    onHandle: handle,
    dialog
  }, $[14] = currentUser, $[15] = dialog, $[16] = discardChanges.disabled, $[17] = isPermissionsLoading, $[18] = isPublished, $[19] = liveEdit, $[20] = permissions?.granted, $[21] = published, $[22] = t2, $[23] = t7) : t7 = $[23];
  let t8;
...
var useDuplicateAction = (t0) => {
  ...
  let t22;
  $[4] !== documentStore.pair || $[5] !== duplicate || $[6] !== id || $[7] !== mapDocument || $[8] !== navigateIntent || $[9] !== type ? (t22 = async () => {
  ...
  }, $[4] = documentStore.pair, $[5] = duplicate, $[6] = id, $[7] = mapDocument, $[8] = navigateIntent, $[9] = type, $[10] = t22) : t22 = $[10];
  const handle = t22;
  let t3;
  bb0: {
    if (!isPermissionsLoading && !permissions?.granted) {
      let t42;
      $[11] !== t2 ? (t42 = t2("action.duplicate.label"), $[11] = t2, $[12] = t42) : t42 = $[12];
      let t52;
      $[13] !== currentUser ? (t52 = (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessage, { context: "duplicate-document", currentUser }), $[13] = currentUser, $[14] = t52) : t52 = $[14];
      let t62;
      $[15] !== t42 || $[16] !== t52 ? (t62 = {
        icon: CopyIcon,
        disabled: true,
    ...
    let t5;
    $[18] !== isDuplicating || $[19] !== t2 ? (t5 = t2(isDuplicating ? "action.duplicate.running.label" : "action.duplicate.label"), $[18] = isDuplicating, $[19] = t2, $[20] = t5) : t5 = $[20];
    let t6;
    $[21] !== duplicate.disabled || $[22] !== t2 ? (t6 = duplicate.disabled ? t2(DISABLED_REASON_KEY$1[duplicate.disabled]) : "", $[21] = duplicate.disabled, $[22] = t2, $[23] = t6) : t6 = $[23];
    let t7;
...
var usePublishAction = (props) => {
  const $ = (0, import_react_compiler_runtime2.c)(79), {
    id,
    type,
    liveEdit,
    draft,
  ...
  let t8;
  $[36] !== changesOpen || $[37] !== currentPublishRevision || $[38] !== publishState ? (t8 = [changesOpen, publishState, currentPublishRevision], $[36] = changesOpen, $[37] = currentPublishRevision, $[38] = publishState, $[39] = t8) : t8 = $[39], (0, import_react2.useEffect)(t7, t8);
  ...
  bb0: {
    ...
    if (isPublishedId(value._id) && draft !== null) {
      let t112;
      $[49] !== t2 ? (t112 = t2("action.publish.label"), $[49] = t2, $[50] = t112) : t112 = $[50];
      const t122 = published?._updatedAt;
      let t132;
      $[51] !== t2 || $[52] !== t122 ? (t132 = getDisabledReason("ALREADY_PUBLISHED", t122, t2), $[51] = t2, $[52] = t122, $[53] = t132) : t132 = $[53];
      let t142;
    ...
    if (!isPermissionsLoading && !permissions?.granted) {
      let t112;
      $[57] !== t2 ? (t112 = t2("action.publish.label"), $[57] = t2, $[58] = t112) : t112 = $[58];
      let t122;
      $[59] !== currentUser ? (t122 = (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessage, { context: "publish-document", currentUser }), $[59] = currentUser, $[60] = t122) : t122 = $[60];
      let t132;
    ...
    let t12;
    $[64] !== publishScheduled || $[65] !== publishState?.status || $[66] !== t2 ? (t12 = publishState?.status === "published" ? t2("action.publish.published.label") : publishScheduled || publishState?.status === "publishing" ? t2("action.publish.running.label") : t2("action.publish.draft.label"), $[64] = publishScheduled, $[65] = publishState?.status, $[66] = t2, $[67] = t12) : t12 = $[67];
    let t13;
    $[68] !== publishScheduled || $[69] !== publishState?.status || $[70] !== t2 || $[71] !== title ? (t13 = publishScheduled ? t2("action.publish.waiting") : publishState?.status === "published" || publishState?.status === "publishing" ? null : title, $[68] = publishScheduled, $[69] = publishState?.status, $[70] = t2, $[71] = title, $[72] = t13) : t13 = $[72];
...
var DocumentStatusBarActionsInner = (0, import_react2.memo)(function(props) {
  ...
  let t7;
  return $[32] !== t3 || $[33] !== t4 || $[34] !== t5 || $[35] !== t6 ? (t7 = (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 1, children: [
    t3,
    t4,
    t5,
    t6
...
var DocumentStatusBarActions = (0, import_react2.memo)(function() {
  const $ = (0, import_react_compiler_runtime2.c)(1);
  let t0;
  return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { group: "default", children: _temp2$b }), $[0] = t0) : t0 = $[0], t0;
});
...
var HistoryStatusBarActions = (0, import_react2.memo)(function() {
  const $ = (0, import_react_compiler_runtime2.c)(1);
  let t0;
  return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { group: "default", children: _temp4$7 }), $[0] = t0) : t0 = $[0], t0;
});
...
function TimelineItem(t0) {
  const $ = (0, import_react_compiler_runtime2.c)(55), {
    chunk,
    isSelected,
    onSelect,
    collaborators,
...
var Timeline = (t0) => {
  ...
  let t13, t14;
  $[35] === Symbol.for("react.memo_cache_sentinel") ? (t13 = () => setMounted(true), t14 = [], $[35] = t13, $[36] = t14) : (t13 = $[35], t14 = $[36]), (0, import_react2.useEffect)(t13, t14);
...
function TimelineMenu(t0) {
  ...
  const handleOpen = t1;
  let t22;
  $[1] === Symbol.for("react.memo_cache_sentinel") ? (t22 = () => {
    setOpen(false);
  }, $[1] = t22) : t22 = $[1];
  ...
  bb0: {
    if (timelineError) {
      let t93;
      $[21] === Symbol.for("react.memo_cache_sentinel") ? (t93 = (0, import_jsx_runtime2.jsx)(TimelineError, {}), $[21] = t93) : t93 = $[21], t8 = t93;
      break bb0;
    }
    if (mode === "rev") {
      let t93;
...
function RevisionStatusLine() {
  ...
  const message = t22;
  let t3;
  $[2] === Symbol.for("react.memo_cache_sentinel") ? (t3 = (0, import_jsx_runtime2.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(RestoreIcon, {}) }) }), $[2] = t3) : t3 = $[2];
  let t4;
...
var HiddenCheckmarkIcon = () => {
  const $ = (0, import_react_compiler_runtime2.c)(1);
  let t0;
  return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime2.jsx)(CheckmarkIcon, { style: {
    visibility: "hidden"
  } }), $[0] = t0) : t0 = $[0], t0;
};
...
function DocumentLayout() {
  const $ = (0, import_react_compiler_runtime2.c)(82), {
    changesOpen,
    displayed,
    documentId,
    documentType,
  ...
  let t22;
  $[5] === Symbol.for("react.memo_cache_sentinel") ? (t22 = [], $[5] = t22) : t22 = $[5];
  ...
  let t21;
  $[65] === Symbol.for("react.memo_cache_sentinel") ? (t21 = (0, import_jsx_runtime2.jsx)(DocumentOperationResults, {}), $[65] = t21) : t21 = $[65];
  let t222;
...
var useDocumentLastRev = (documentId, documentType) => {
  const $ = (0, import_react_compiler_runtime2.c)(11), historyStore = useHistoryStore(), [lastRevisionDocument, setLastRevisionDocument] = (0, import_react2.useState)(null), [loading, setLoading] = (0, import_react2.useState)(false);
  let t0;
...
function useDocumentPaneInspector(t0) {
  const $ = (0, import_react_compiler_runtime2.c)(54), {
    documentId,
    documentType,
    params,
    setParams
...
function DocumentPaneProvider(props) {
  const $ = (0, import_react_compiler_runtime2.c)(205), {
    children,
    index,
    pane: pane2,
    paneKey,
...
var DocumentPaneProviderWrapper = (0, import_react2.memo)((props) => {
  const $ = (0, import_react_compiler_runtime2.c)(9), source = useSource(), {
    setParams,
    params
  } = usePaneRouter();
  let t0;
...
function DocumentPaneInner(props) {
  const $ = (0, import_react_compiler_runtime2.c)(57), {
    pane: pane2,
    paneKey
  } = props, {
...
function PaneRouterProvider(props) {
  const $ = (0, import_react_compiler_runtime2.c)(60), {
    children,
    flatIndex,
    index,
    params,
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./_chunks-es-CLRIFYZE.js")),
  ...
  list: (0, import_react2.lazy)(() => import("./index2-QQAN4XBV.js"))
};
...
function ConfirmDeleteDialogBody(t0) {
  const $ = (0, import_react_compiler_runtime2.c)(59), {
  ...
  let t22;
  $[10] !== hasUnknownDatasetNames ? (t22 = hasUnknownDatasetNames ? ["unavailable"] : [], $[10] = hasUnknownDatasetNames, $[11] = t22) : t22 = $[11];
  let t3;
  $[12] !== datasetNames || $[13] !== t22 ? (t3 = [...datasetNames, ...t22], $[12] = datasetNames, $[13] = t22, $[14] = t3) : t3 = $[14];
  ...
  let t7;
  $[15] !== normalizedDatasetNames.length || $[16] !== t2 || $[17] !== t5 || $[18] !== t6 ? (t7 = t2("confirm-delete-dialog.cdr-summary.subtitle", {
    count: t4,
    datasets: t5,
    context: t6
  }), $[15] = normalizedDatasetNames.length, $[16] = t2, $[17] = t5, $[18] = t6, $[19] = t7) : t7 = $[19];
  const datasetSubtitle = t7;
  let t8;
  $[20] === Symbol.for("react.memo_cache_sentinel") ? (t8 = (0, import_jsx_runtime2.jsx)(Text, { "aria-hidden": "true", size: 1, children: (0, import_jsx_runtime2.jsx)(WarningOutlineIcon, {}) }), $[20] = t8) : t8 = $[20];
  let t9;
  $[21] !== documentTitle ? (t9 = {
  ...
  let t11;
  $[25] !== t2 || $[26] !== t10 || $[27] !== t9 ? (t11 = (0, import_jsx_runtime2.jsx)(Card, { padding: 3, radius: 2, tone: "caution", flex: "none", children: (0, import_jsx_runtime2.jsxs)(Flex, { children: [
    t8,
    (0, import_jsx_runtime2.jsx)(Box, { flex: 1, marginLeft: 3, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { i18nKey: "confirm-delete-dialog.referring-document-count.text", components: t9, t: t2, values: t10 }) }) })
  ] }) }), $[25] = t2, $[26] = t10, $[27] = t9, $[28] = t11) : t11 = $[28];
  let t12;
  $[29] !== documentTitle ? (t12 = {
    DocumentTitle: () => documentTitle
  }, $[29] = documentTitle, $[30] = t12) : t12 = $[30];
  let t13;
  $[31] !== action || $[32] !== t2 || $[33] !== t12 ? (t13 = (0, import_jsx_runtime2.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { i18nKey: "confirm-delete-dialog.referring-documents-descriptor.text", t: t2, context: action, components: t12 }) }) }), $[31] = action, $[32] = t2, $[33] = t12, $[34] = t13) : t13 = $[34];
  let t14;
  $[35] !== internalReferences || $[36] !== renderPreviewItem ? (t14 = internalReferences.totalCount > 0 && (0, import_jsx_runtime2.jsxs)(Stack, { as: "ul", marginBottom: 2, space: 2, "data-testid": "internal-references", children: [
  ...
  let t15;
  $[38] !== crossDatasetReferences || $[39] !== datasetSubtitle || $[40] !== internalReferences.totalCount || $[41] !== normalizedDatasetNames.length || $[42] !== t2 || $[43] !== toast ? (t15 = crossDatasetReferences.totalCount > 0 && (0, import_jsx_runtime2.jsxs)(CrossDatasetReferencesDetails, { "data-testid": "cross-dataset-references", style: {
    ...
    (0, import_jsx_runtime2.jsxs)(Box, { overflow: "auto", paddingTop: 2, children: [
      (0, import_jsx_runtime2.jsxs)(Table$1, { children: [
        ...
        (0, import_jsx_runtime2.jsx)("tbody", { children: crossDatasetReferences.references.filter(_temp$e).map((t162, index) => {
          const {
            projectId,
            datasetName,
            documentId
  ...
  ] }), $[38] = crossDatasetReferences, $[39] = datasetSubtitle, $[40] = internalReferences.totalCount, $[41] = normalizedDatasetNames.length, $[42] = t2, $[43] = toast, $[44] = t15) : t15 = $[44];
  let t16;
  $[45] !== t14 || $[46] !== t15 ? (t16 = (0, import_jsx_runtime2.jsx)(Card, { radius: 2, shadow: 1, flex: "auto", padding: 2, children: (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", children: [
    t14,
    t15
  ...
  let t18;
  $[50] !== action || $[51] !== t2 || $[52] !== t17 ? (t18 = (0, import_jsx_runtime2.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { i18nKey: "confirm-delete-dialog.referential-integrity-disclaimer.text", t: t2, context: action, components: t17 }) }) }), $[50] = action, $[51] = t2, $[52] = t17, $[53] = t18) : t18 = $[53];
  let t19;
  return $[54] !== t11 || $[55] !== t13 || $[56] !== t16 || $[57] !== t18 ? (t19 = (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", gap: 4, children: [
    t11,
    t13,
    t16,
    t18
...
function useReferringDocuments(documentId) {
  const $ = (0, import_react_compiler_runtime2.c)(24), versionedClient = useClient(DEFAULT_STUDIO_CLIENT_OPTIONS), documentStore = useDocumentStore();
  let t0;
...
function ConfirmDeleteDialog(t0) {
  const $ = (0, import_react_compiler_runtime2.c)(40), {
    id,
    type,
    action: t1,
    onCancel,
...
var PaneHeaderActions = (0, import_react2.memo)(function(props) {
  ...
  let t9;
  $[15] !== initialValueTemplateItemFromMenuItems || $[16] !== initialValueTemplateItemsFromStructure ? (t9 = (0, import_uniqBy.default)([...initialValueTemplateItemFromMenuItems, ...initialValueTemplateItemsFromStructure], _temp3$3), $[15] = initialValueTemplateItemFromMenuItems, $[16] = initialValueTemplateItemsFromStructure, $[17] = t9) : t9 = $[17];
...
function PaneItem(props) {
  const $ = (0, import_react_compiler_runtime2.c)(42), {
    icon,
    id,
    layout: t0,
    pressed,
...
function DocumentListPaneContent(props) {
  const $ = (0, import_react_compiler_runtime2.c)(66), {
    childItemId,
    error,
    isRetrying,
    autoRetry,
...
function useDocumentList(opts) {
  const $ = (0, import_react_compiler_runtime2.c)(33), {
    ...
    perspective,
    apiVersion
  } = opts, t0 = apiVersion || DEFAULT_STUDIO_CLIENT_OPTIONS.apiVersion;
  let t1;
  $[0] !== t0 ? (t1 = {
    ...DEFAULT_STUDIO_CLIENT_OPTIONS,
    apiVersion: t0
  ...
  const typeNameFromFilter = t2, [t3] = (0, import_react2.useState)(_temp$8), [onRetry$, onRetry] = t3, [t4] = (0, import_react2.useState)(_temp2$4), [onFetchFullList$, onLoadFullList] = t4, t5 = searchQuery || "", t6 = sortOrder || DEFAULT_ORDERING;
  let t7;
  if ($[5] !== client || $[6] !== maxFieldDepth || $[7] !== onFetchFullList$ || $[8] !== onRetry$ || $[9] !== paramsProp || $[10] !== perspective || $[11] !== schema || $[12] !== searchFilter || $[13] !== searchStrategy || $[14] !== t5 || $[15] !== t6 || $[16] !== typeNameFromFilter) {
    ...
    }, $[18] = onRetry$, $[19] = t82) : t82 = $[19], t7 = merge(partialList$.pipe(map(_temp5$1), takeUntil(fullList$)), fullList$).pipe(catchWithCount(t82), scan(_temp6$1, INITIAL_QUERY_STATE)), $[5] = client, $[6] = maxFieldDepth, $[7] = onFetchFullList$, $[8] = onRetry$, $[9] = paramsProp, $[10] = perspective, $[11] = schema, $[12] = searchFilter, $[13] = searchStrategy, $[14] = t5, $[15] = t6, $[16] = typeNameFromFilter, $[17] = t7;
  } else
    t7 = $[17];
...
var DocumentListPane = (0, import_react2.memo)(function(props) {
  const $ = (0, import_react_compiler_runtime2.c)(67), {
    childItemId,
    isActive,
    pane: pane2,
    paneKey,
  ...
  const sortOrder = useUnique(t1);
  let t22;
  $[7] !== searchQuery ? (t22 = searchQuery?.trim(), $[7] = searchQuery, $[8] = t22) : t22 = $[8];
  let t3;
  $[9] !== apiVersion || $[10] !== filter2 || $[11] !== params || $[12] !== perspectiveStack || $[13] !== sortOrder || $[14] !== t22 ? (t3 = {
    apiVersion,
    filter: filter2,
    ...
    searchQuery: t22,
    sortOrder
  }, $[9] = apiVersion, $[10] = filter2, $[11] = params, $[12] = perspectiveStack, $[13] = sortOrder, $[14] = t22, $[15] = t3) : t3 = $[15];
  const {
    error,
    isLoadingFullList,
  ...
  let t4;
  $[16] === Symbol.for("react.memo_cache_sentinel") ? (t4 = (event$) => event$.pipe(map(_temp$7), tap(setSearchInputValue), debounce(_temp2$3), tap(setSearchQuery)), $[16] = t4) : t4 = $[16];
  const handleQueryChange = useObservableEvent(t4);
  let t5;
  ...
  const handleSearchKeyDown = t6, [enableSearchSpinner, setEnableSearchSpinner] = (0, import_react2.useState)();
  let t7, t8;
  $[19] !== enableSearchSpinner || $[20] !== isLoading || $[21] !== paneKey ? (t7 = () => {
    !enableSearchSpinner && !isLoading && setEnableSearchSpinner(paneKey);
  }, t8 = [enableSearchSpinner, isLoading, paneKey], $[19] = enableSearchSpinner, $[20] = isLoading, $[21] = paneKey, $[22] = t7, $[23] = t8) : (t7 = $[22], t8 = $[23]), (0, import_react2.useEffect)(t7, t8);
  let t9;
  $[24] === Symbol.for("react.memo_cache_sentinel") ? (t9 = () => {
    handleClearSearch(), setEnableSearchSpinner();
  }, $[24] = t9) : t9 = $[24];
  let t10;
  $[25] !== paneKey ? (t10 = [paneKey, handleClearSearch], $[25] = paneKey, $[26] = t10) : t10 = $[26], (0, import_react2.useEffect)(t9, t10);
  let t11;
  bb1: {
  ...
  let t13;
  $[27] !== t2 ? (t13 = t2("panes.document-list-pane.search-input.aria-label"), $[27] = t2, $[28] = t13) : t13 = $[28];
  ...
  let t17;
  $[30] !== t2 ? (t17 = t2("panes.document-list-pane.search-input.placeholder"), $[30] = t2, $[31] = t17) : t17 = $[31];
  let t18;
  $[32] !== handleQueryChange || $[33] !== searchInputValue || $[34] !== t13 || $[35] !== t14 || $[36] !== t16 || $[37] !== t17 || $[38] !== textInputIcon ? (t18 = (0, import_jsx_runtime2.jsx)(Box, { paddingX: 3, paddingBottom: 3, children: (0, import_jsx_runtime2.jsx)(TextInput, { "aria-label": t13, autoComplete: "off", border: false, clearButton: t14, fontSize: t15, icon: textInputIcon, iconRight: t16, onChange: handleQueryChange, onClear: handleClearSearch, onKeyDown: handleSearchKeyDown, padding: 2, placeholder: t17, radius: 2, ref: setSearchInputElement, spellCheck: false, value: searchInputValue }) }), $[32] = handleQueryChange, $[33] = searchInputValue, $[34] = t13, $[35] = t14, $[36] = t16, $[37] = t17, $[38] = textInputIcon, $[39] = t18) : t18 = $[39];
  const t19 = !!typeName, t20 = items.length === FULL_LIST_LIMIT, t21 = !!searchQuery, t222 = loadingVariant === "subtle";
  let t23;
  $[40] !== autoRetry || $[41] !== canRetry || $[42] !== childItemId || $[43] !== connected || $[44] !== error || $[45] !== isActive || $[46] !== isLoading || $[47] !== isLoadingFullList || $[48] !== isRetrying || $[49] !== items || $[50] !== layout || $[51] !== loadingVariant || $[52] !== onLoadFullList || $[53] !== onRetry || $[54] !== paneKey || $[55] !== retryCount || $[56] !== searchInputElement || $[57] !== showIcons || $[58] !== t19 || $[59] !== t20 || $[60] !== t21 || $[61] !== t222 || $[62] !== title ? (t23 = (0, import_jsx_runtime2.jsx)(DocumentListPaneContent, { childItemId, error, filterIsSimpleTypeConstraint: t19, hasMaxItems: t20, hasSearchQuery: t21, isActive, isLazyLoading: isLoadingFullList, isLoading, autoRetry, canRetry, retryCount, isRetrying, isConnected: connected, items, layout, muted: t222, loadingVariant, onEndReached: onLoadFullList, onRetry, paneTitle: title, searchInputElement, showIcons }, paneKey), $[40] = autoRetry, $[41] = canRetry, $[42] = childItemId, $[43] = connected, $[44] = error, $[45] = isActive, $[46] = isLoading, $[47] = isLoadingFullList, $[48] = isRetrying, $[49] = items, $[50] = layout, $[51] = loadingVariant, $[52] = onLoadFullList, $[53] = onRetry, $[54] = paneKey, $[55] = retryCount, $[56] = searchInputElement, $[57] = showIcons, $[58] = t19, $[59] = t20, $[60] = t21, $[61] = t222, $[62] = title, $[63] = t23) : t23 = $[63];
  let t24;
  return $[64] !== t18 || $[65] !== t23 ? (t24 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    t18,
    t23
...
function DocumentSheetListPane(props) {
  const $ = (0, import_react_compiler_runtime2.c)(7), schema = useSchema(), typeName = props.pane.schemaTypeName;
  let schemaType, t0;
...
var addSelectedStateToMenuItems = (options) => {
  ...
  return menuItems?.map((item) => item.params?.layout ? {
    ...
    ...item,
    selected: (0, import_isEqual.default)(sortOrderRaw?.by, item?.params?.by || EMPTY_ARRAY$B)
  } : {
    ...item,
    selected: false
  });
...
function ChangesInspector(t0) {
  ...
  if (selectedReleaseId) {
    let t22;
    return $[6] === Symbol.for("react.memo_cache_sentinel") ? (t22 = (0, import_jsx_runtime2.jsx)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: (0, import_jsx_runtime2.jsx)(Card, { flex: 1, padding: 2, paddingTop: 0, children: (0, import_jsx_runtime2.jsx)(TimelineError, { versionError: true }) }) }), $[6] = t22) : t22 = $[6], t22;
  }
  let t2;
...
var EventsTimeline = (t0) => {
  const $ = (0, import_react_compiler_runtime2.c)(38), {
    events: allEvents,
    hasMoreEvents,
    selectedEventId,
    onLoadMore,
  ...
  const renderItem = t8;
  let t10, t9;
  $[21] === Symbol.for("react.memo_cache_sentinel") ? (t9 = () => setMounted(true), t10 = [], $[21] = t10, $[22] = t9) : (t10 = $[21], t9 = $[22]), (0, import_react2.useEffect)(t9, t10);
  let t11;
...
function EventsTimelineMenu(t0) {
  const $ = (0, import_react_compiler_runtime2.c)(58), {
    event,
    events,
    mode,
    placement
  ...
  bb0: {
    if (eventsError) {
      let t93;
      $[22] === Symbol.for("react.memo_cache_sentinel") ? (t93 = (0, import_jsx_runtime2.jsx)(TimelineError, {}), $[22] = t93) : t93 = $[22], t8 = t93;
      break bb0;
    }
...
var CompareWithPublishedView = () => {
  const $ = (0, import_react_compiler_runtime2.c)(31), {
    documentId,
    schemaType,
    editState,
    displayed
...
function EventsInspector(t0) {
  const $ = (0, import_react_compiler_runtime2.c)(83), {
    showChanges
  } = t0, {
    documentId,
    schemaType,
...
function Content(t0) {
  const $ = (0, import_react_compiler_runtime2.c)(15), {
    error,
    documentContext,
    loading,
    schemaType,
...
function ChangesTabs(props) {
  const $ = (0, import_react_compiler_runtime2.c)(72), {
    params,
    setParams
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-I4ANXXCP.js")),
...
//# sourceMappingURL=chunk-A4S23MCX.js.map
