...
import { useEffect, forwardRef, useRef, useState, useContext, useImperativeHandle, useLayoutEffect, useId, memo, Fragment as Fragment$1, useDeferredValue, lazy, Suspense, startTransition, useCallback, useMemo, useReducer } from "react";
...
import { MenuGroup, ConfirmPopover } from "./MenuGroup.mjs";
...
function DocumentActionsProvider(props) {
  ...
  const t3 = actions || EMPTY_ARRAY$2;
  let t4;
  ...
  let t5;
  return $[10] !== t2 || $[11] !== t3 || $[12] !== t4 ? (t5 = /* @__PURE__ */ jsx(GetHookCollectionState, { args: t2, hooks: t3, resetRef: onCompleteRef, children: t4 }), $[10] = t2, $[11] = t3, $[12] = t4, $[13] = t5) : t5 = $[13], t5;
}
...
`, CANVAS_IMAGE_URL = "https://cdn.sanity.io/images/pyrmmpch/production/b47224e2f3a7d1747e43b9da1ac31739250e628b-632x376.png", CANVAS_APP_NAME = "Canvas", CanvasPopoverContent = (t0) => {
  ...
  let t11;
  $[17] !== t10 ? (t11 = /* @__PURE__ */ jsx(Flex, { width: "full", gap: 3, justify: "flex-end", paddingX: 4, paddingBottom: 4, children: /* @__PURE__ */ jsx(Button$1, { mode: "bleed", text: t10, autoFocus: !0, tone: "primary", href: "https://snty.link/canvas-docs", target: "_blank", rel: "noopener noreferrer", as: "a", iconRight: LaunchIcon }) }), $[17] = t10, $[18] = t11) : t11 = $[18];
  let t12;
...
function OpenReleaseToEditBannerInner(t0) {
  ...
  let t10;
  return $[32] !== t7 || $[33] !== t9 || $[34] !== tone ? (t10 = /* @__PURE__ */ jsx(Banner, { tone, "data-testid": "open-release-to-edit-banner", content: t7, action: t9 }), $[32] = t7, $[33] = t9, $[34] = tone, $[35] = t10) : t10 = $[35], t10;
}
...
const TooltipContent$1 = (t0) => {
  ...
  const onlyHasVersions = useOnlyHasVersions(t2), workspace = useWorkspace(), {
  ...
  let t11;
  $[35] !== dateTimeFormat || $[36] !== editState?.published || $[37] !== t ? (t11 = /* @__PURE__ */ jsx(Text, { size: 1, children: editState?.published && editState?.published?._updatedAt ? /* @__PURE__ */ jsx(Translate, { t, i18nKey: "release.chip.tooltip.published-date", values: {
  ...
  let t18;
  $[50] !== handleCopyToDraftsNavigate || $[51] !== isPublishSelected || $[52] !== isPublishedChipDisabled || $[53] !== t11 || $[54] !== t12 || $[55] !== t13 || $[56] !== t17 ? (t18 = /* @__PURE__ */ jsx(VersionChip, { tooltipContent: t11, disabled: isPublishedChipDisabled, onClick: t12, selected: isPublishSelected, text: t13, tone: "positive", onCopyToDraftsNavigate: handleCopyToDraftsNavigate, contextValues: t17 }), $[50] = handleCopyToDraftsNavigate, $[51] = isPublishSelected, $[52] = isPublishedChipDisabled, $[53] = t11, $[54] = t12, $[55] = t13, $[56] = t17, $[57] = t18) : t18 = $[57];
  let t19;
  $[58] !== dateTimeFormat || $[59] !== documentType || $[60] !== editState?.draft || $[61] !== editState?.id || $[62] !== editState?.published?._id || $[63] !== filteredReleases.notCurrentReleases || $[64] !== handleCopyToDraftsNavigate || $[65] !== handlePerspectiveChange || $[66] !== isDraftDisabled || $[67] !== isDraftModelEnabled || $[68] !== isDraftSelected || $[69] !== isLiveEdit || $[70] !== loading || $[71] !== t ? (t19 = isDraftModelEnabled && /* @__PURE__ */ jsx(VersionChip, { tooltipContent: /* @__PURE__ */ jsx(Text, { size: 1, children: editState?.draft ? /* @__PURE__ */ jsx(Fragment, { children: editState?.draft._updatedAt ? /* @__PURE__ */ jsx(Translate, { t, i18nKey: "release.chip.tooltip.edited-date", values: {
  ...
  let t20;
  $[73] !== displayed?._id || $[74] !== documentType || $[75] !== filteredReleases.inCreation || $[76] !== filteredReleases.notCurrentReleases || $[77] !== handleCopyToDraftsNavigate || $[78] !== loading || $[79] !== t ? (t20 = filteredReleases.inCreation && /* @__PURE__ */ jsx(VersionChip, { tooltipContent: /* @__PURE__ */ jsx(TooltipContent$1, { release: filteredReleases.inCreation }), selected: !0, onClick: _temp$t, locked: !1, tone: getReleaseTone(filteredReleases.inCreation), text: filteredReleases.inCreation.metadata.title || t("release.placeholder-untitled-release"), onCopyToDraftsNavigate: handleCopyToDraftsNavigate, contextValues: {
    disabled: !0,
  ...
  let t21;
  $[81] !== displayed || $[82] !== documentType || $[83] !== editState?.version || $[84] !== filteredReleases.currentReleases || $[85] !== filteredReleases.notCurrentReleases || $[86] !== getReleaseChipState || $[87] !== handleCopyToDraftsNavigate || $[88] !== handlePerspectiveChange || $[89] !== loading || $[90] !== t ? (t21 = displayed && filteredReleases.currentReleases?.map((release_0) => /* @__PURE__ */ jsx(VersionChip, { tooltipContent: /* @__PURE__ */ jsx(TooltipContent$1, { release: release_0 }), ...getReleaseChipState(release_0), onClick: handlePerspectiveChange(release_0), text: release_0.metadata.title || t("release.placeholder-untitled-release"), tone: getReleaseTone(release_0), locked: isReleaseScheduledOrScheduling(release_0), onCopyToDraftsNavigate: handleCopyToDraftsNavigate, contextValues: {
    documentId: displayed?._id || "",
  ...
  let t22;
  return $[92] !== t18 || $[93] !== t19 || $[94] !== t20 || $[95] !== t21 ? (t22 = /* @__PURE__ */ jsxs(Fragment, { children: [
    t18,
    t19,
    t20,
    t21
...
const HorizontalScroller = styled(Card)((props) => {
  ...
  return $[18] !== BackLink2 || $[19] !== backButton || $[20] !== collapsed || $[21] !== connectionState || $[22] !== contextMenuNodes || $[23] !== editState || $[24] !== handleFocusPane || $[25] !== isMaximizedPane || $[26] !== menuButtonNodes || $[27] !== onPaneClose || $[28] !== onPaneSplit || $[29] !== onSetMaximizedPane || $[30] !== ref || $[31] !== referenceElement || $[32] !== schemaType || $[33] !== showGradient || $[34] !== showPaneGroupCloseButton || $[35] !== showSplitPaneButton || $[36] !== showSplitPaneCloseButton || $[37] !== t || $[38] !== tabIndex || $[39] !== unstable_languageFilter ? (t7 = /* @__PURE__ */ jsx(TooltipDelayGroupProvider, { children: collapsed ? /* @__PURE__ */ jsx(PaneHeader$1, { border: !0, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabIndex, backButton }) : /* @__PURE__ */ jsx(Card, { hidden: collapsed, style: {
    ...
    /* @__PURE__ */ jsx(Box, { flex: "none", paddingRight: 3, children: /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 1, children: [
      ...
      editState && /* @__PURE__ */ jsx(RenderActionCollectionState, { group: "paneActions", children: (t8) => {
        const {
          states: states_0
        } = t8;
        return /* @__PURE__ */ jsx(DocumentPanelHeaderActionDialogDeferred, { contextMenuNodes, setReferenceElement, referenceElement, states: states_0 });
      } }),
...
const DISABLED_REASON_TITLE_KEY$1 = {
  ...
  bb0: {
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t72;
      $[11] !== currentUser ? (t72 = /* @__PURE__ */ jsx(InsufficientPermissionsMessage, { context: "delete-document", currentUser }), $[11] = currentUser, $[12] = t72) : t72 = $[12];
      let t82;
      $[13] !== t62 || $[14] !== t72 ? (t82 = {
        tone: "critical",
        icon: TrashIcon,
...
const DISABLED_REASON_KEY$2 = {
  ...
  let t2;
  $[4] !== displayed?._id ? (t2 = displayed?._id && isPublishedId(displayed?._id), $[4] = displayed?._id, $[5] = t2) : t2 = $[5];
...
const usePublishAction = (props) => {
  ...
  bb0: {
    ...
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t122;
      $[59] !== currentUser ? (t122 = /* @__PURE__ */ jsx(InsufficientPermissionsMessage, { context: "publish-document", currentUser }), $[59] = currentUser, $[60] = t122) : t122 = $[60];
      let t132;
...
const STATUS_DICTIONARY = {
  ...
  minimal: !0,
  useTemporalPhrase: !0
}, MotionButton = motion.create(Button), MotionBox = motion.create(Box), ButtonSkeleton = () => {
  const $ = c(2);
  let t0;
...
const paneMap = {
  component: lazy(() => import("./index.mjs")),
...
function ConfirmDeleteDialogBody(t0) {
  ...
  let t8;
  $[20] === Symbol.for("react.memo_cache_sentinel") ? (t8 = /* @__PURE__ */ jsx(Text, { "aria-hidden": "true", size: 1, children: /* @__PURE__ */ jsx(WarningOutlineIcon, {}) }), $[20] = t8) : t8 = $[20];
  let t9;
  $[21] !== documentTitle ? (t9 = {
  ...
  let t11;
  $[25] !== t || $[26] !== t10 || $[27] !== t9 ? (t11 = /* @__PURE__ */ jsx(Card, { padding: 3, radius: 2, tone: "caution", flex: "none", children: /* @__PURE__ */ jsxs(Flex, { children: [
    t8,
    /* @__PURE__ */ jsx(Box, { flex: 1, marginLeft: 3, children: /* @__PURE__ */ jsx(Text, { size: 1, children: /* @__PURE__ */ jsx(Translate, { i18nKey: "confirm-delete-dialog.referring-document-count.text", components: t9, t, values: t10 }) }) })
  ...
  let t13;
  $[31] !== action || $[32] !== t || $[33] !== t12 ? (t13 = /* @__PURE__ */ jsx(Box, { flex: "none", children: /* @__PURE__ */ jsx(Text, { size: 1, children: /* @__PURE__ */ jsx(Translate, { i18nKey: "confirm-delete-dialog.referring-documents-descriptor.text", t, context: action, components: t12 }) }) }), $[31] = action, $[32] = t, $[33] = t12, $[34] = t13) : t13 = $[34];
  let t14;
  $[35] !== internalReferences || $[36] !== renderPreviewItem ? (t14 = internalReferences.totalCount > 0 && /* @__PURE__ */ jsxs(Stack, { as: "ul", marginBottom: 2, space: 2, "data-testid": "internal-references", children: [
  ...
  let t15;
  $[38] !== crossDatasetReferences || $[39] !== datasetSubtitle || $[40] !== internalReferences.totalCount || $[41] !== normalizedDatasetNames.length || $[42] !== t || $[43] !== toast ? (t15 = crossDatasetReferences.totalCount > 0 && /* @__PURE__ */ jsxs(CrossDatasetReferencesDetails, { "data-testid": "cross-dataset-references", style: {
    ...
    /* @__PURE__ */ jsxs(Box, { overflow: "auto", paddingTop: 2, children: [
      /* @__PURE__ */ jsxs(Table$1, { children: [
        ...
        /* @__PURE__ */ jsx("tbody", { children: crossDatasetReferences.references.filter(_temp$e).map((t162, index) => {
          const {
            projectId,
            datasetName,
            documentId
          ...
          return /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsxs(DocumentIdFlex, { align: "center", gap: 2, justify: "flex-end", children: [
              ...
              documentId && /* @__PURE__ */ jsx(Button$1, { mode: "bleed", icon: CopyIcon, tooltipProps: {
  ...
  let t16;
  $[45] !== t14 || $[46] !== t15 ? (t16 = /* @__PURE__ */ jsx(Card, { radius: 2, shadow: 1, flex: "auto", padding: 2, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", children: [
    t14,
    t15
  ...
  let t18;
  $[50] !== action || $[51] !== t || $[52] !== t17 ? (t18 = /* @__PURE__ */ jsx(Box, { flex: "none", children: /* @__PURE__ */ jsx(Text, { size: 1, children: /* @__PURE__ */ jsx(Translate, { i18nKey: "confirm-delete-dialog.referential-integrity-disclaimer.text", t, context: action, components: t17 }) }) }), $[50] = action, $[51] = t, $[52] = t17, $[53] = t18) : t18 = $[53];
  let t19;
  return $[54] !== t11 || $[55] !== t13 || $[56] !== t16 || $[57] !== t18 ? (t19 = /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 4, children: [
    t11,
    t13,
    t16,
    t18
...
function useDocumentList(opts) {
  ...
  const typeNameFromFilter = t2, [t3] = useState(_temp$8), [onRetry$, onRetry] = t3, [t4] = useState(_temp2$4), [onFetchFullList$, onLoadFullList] = t4, t5 = searchQuery || "", t6 = sortOrder || DEFAULT_ORDERING;
  let t7;
  if ($[5] !== client || $[6] !== maxFieldDepth || $[7] !== onFetchFullList$ || $[8] !== onRetry$ || $[9] !== paramsProp || $[10] !== perspective || $[11] !== schema || $[12] !== searchFilter || $[13] !== searchStrategy || $[14] !== t5 || $[15] !== t6 || $[16] !== typeNameFromFilter) {
    ...
    }, $[18] = onRetry$, $[19] = t82) : t82 = $[19], t7 = merge(partialList$.pipe(map$1(_temp5$1), takeUntil(fullList$)), fullList$).pipe(catchWithCount(t82), scan(_temp6$1, INITIAL_QUERY_STATE)), $[5] = client, $[6] = maxFieldDepth, $[7] = onFetchFullList$, $[8] = onRetry$, $[9] = paramsProp, $[10] = perspective, $[11] = schema, $[12] = searchFilter, $[13] = searchStrategy, $[14] = t5, $[15] = t6, $[16] = typeNameFromFilter, $[17] = t7;
  } else
    t7 = $[17];
...
`, DocumentListPane = memo(function(props) {
  ...
  let t3;
  $[9] !== apiVersion || $[10] !== filter2 || $[11] !== params || $[12] !== perspectiveStack || $[13] !== sortOrder || $[14] !== t2 ? (t3 = {
    apiVersion,
    filter: filter2,
    ...
    searchQuery: t2,
    sortOrder
  }, $[9] = apiVersion, $[10] = filter2, $[11] = params, $[12] = perspectiveStack, $[13] = sortOrder, $[14] = t2, $[15] = t3) : t3 = $[15];
  const {
    error,
    isLoadingFullList,
  ...
  let t4;
  $[16] === Symbol.for("react.memo_cache_sentinel") ? (t4 = (event$) => event$.pipe(map(_temp$7), tap$1(setSearchInputValue), debounce(_temp2$3), tap$1(setSearchQuery)), $[16] = t4) : t4 = $[16];
  ...
  const handleSearchKeyDown = t6, [enableSearchSpinner, setEnableSearchSpinner] = useState();
  let t7, t8;
  $[19] !== enableSearchSpinner || $[20] !== isLoading || $[21] !== paneKey ? (t7 = () => {
    !enableSearchSpinner && !isLoading && setEnableSearchSpinner(paneKey);
  }, t8 = [enableSearchSpinner, isLoading, paneKey], $[19] = enableSearchSpinner, $[20] = isLoading, $[21] = paneKey, $[22] = t7, $[23] = t8) : (t7 = $[22], t8 = $[23]), useEffect(t7, t8);
  let t9;
  $[24] === Symbol.for("react.memo_cache_sentinel") ? (t9 = () => {
    handleClearSearch(), setEnableSearchSpinner();
  }, $[24] = t9) : t9 = $[24];
  let t10;
  $[25] !== paneKey ? (t10 = [paneKey, handleClearSearch], $[25] = paneKey, $[26] = t10) : t10 = $[26], useEffect(t9, t10);
  let t11;
  bb1: {
...
const documentActions = [usePublishAction, useUnpublishAction, useDiscardChangesAction, useDuplicateAction, useDeleteAction, useHistoryRestoreAction], documentBadges = [useLiveEditBadge], inspectors = [validationInspector, changesInspector], structureTool = definePlugin((options) => {
